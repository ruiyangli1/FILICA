...
This file demonstrates the implementation of FI-LICA in R, under both MAR and MCAR settings. 
...
* MATLAB scripts to run LICA are named as `code_*.m` (i.e., `code_completer.m`, `code_filica_update.m`, `code_nomiss.m`, `code_replace0.m`). ***Please make sure to change the path to `your path/FILICA/MATLAB_code/flica` in each script based on your folder location!***
* Current version supports analysis for 2 modalities
