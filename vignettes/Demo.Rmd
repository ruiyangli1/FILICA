...
The same version of this file with *printed-out results* can also bee seen at our [GitHub website](https://github.com/ruiyangli1/FILICA), named as `Demo.html`. 
...
# -- generate data -- 
data0 = data_generate_MAR_ctnsH(nsubj = 100, seed = 7452, n_miss = 5) #--- n_miss doesn't matter b/c will only use no-miss data from data_generate()
...
```{r fig.width = 7, fig.height = 5}
# -- generate data -- 
data0 = data_generate_MAR_ctnsH(nsubj = 100, seed = 7452, n_miss = 5) 
# prepare data in lists
...
* n = 100
* miss 5% of data
* same code as above, expect using `data_generate_MAR`() instead of `data_generate_MAR_ctnsH()` for data generation
